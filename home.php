...
<body>
    ...
    <section class="body-s1">
        ...
        <div class="faq">
            ...
            <div class="content">
                <ol>
                    <li>Si tu equipo presenta fallas o problemas de configuración, debes comunicarte con nosotros por mensaje al WhatsApp +51 970 539 751 detallando los inconvenientes. No olvides indicar: marca, modelo, número de serie y comprobante de pago.</li>
