...
$(document).ready(function () {
  // Verificar si ya hay órdenes guardadas en el localStorage
  const cachedOrders = localStorage.getItem('orders');
  if (cachedOrders) {
    showOrders(JSON.parse(cachedOrders)); // Mostrar órdenes guardadas en cache
  }
