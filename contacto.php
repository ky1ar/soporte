...
<body>
    ...
    <section class="contact-info">
        <a href="mailto:soporte@krear3d.com" class="card">
            <h1>Email</h1>
            <img src="assets/img/home-email.png" alt="">
            <p>soporte@krear3d.com</p>
        </a>
        <a href="https://wa.me/51970539751" target="_blank" class="card">
            <h1>WhatsApp</h1>
            <img src="assets/img/whatsapp.png" alt="">
            <p>+51 970 539 751</p>
        </a>
        <a href="https://www.google.com/maps/search/?api=1&query=Calle+Tutumo+116%2C+Surco" target="_blank" class="card">
            <h1>Encuéntranos</h1>
