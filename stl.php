...
<body>
    ...
    <div class="categorias-stl-mid">
        ...
        <div class="swiffy-slider slider-item-show7 slider-nav-round slider-nav-dark slider-nav-sm slider-nav-outside-expand slider-nav-visible slider-nav-autohide slider-indicators-outside">
            <div class="buttons">
